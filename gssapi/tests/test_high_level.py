...
class CredsTestCase(_GSSAPIKerberosTestCase):
    ...
    def test_store_into_acquire_from(self):
        ...
        self.assertTrue(store_res.mechs)
        self.assertEqual(store_res.usage, 'initiate')
...
class MechsTestCase(_GSSAPIKerberosTestCase):
    ...
    def test_sasl_properties(self):
        ...
        for mech in mechs:
            ...
            if mech.sasl_name:
                self.assertIsInstance(mech.sasl_name, six.text_type)

            if mech.description:
                self.assertIsInstance(mech.description, six.text_type)
...
class NamesTestCase(_GSSAPIKerberosTestCase):
    ...
    def test_display_as(self):
        ...
        self.assertEqual(six.text_type(canonical_name), princ_str)
        self.assertIsInstance(krb_name, six.text_type)
    ...
    def test_create_from_composite_token_with_attrs(self):
        ...
        self.assertEqual(name2.attributes['urn:greet:greeting'].values,
                         set([b'some val']))
        self.assertTrue(name2.attributes['urn:greet:greeting'].complete)
        self.assertFalse(name2.attributes['urn:greet:greeting'].authenticated)
    ...
    def test_to_unicode(self):
        ...
        self.assertIsInstance(name_str, six.text_type)
    ...
    def test_to_bytes(self):
        ...
        self.assertIsInstance(name_bytes, bytes)
        self.assertEqual(name_bytes, SERVICE_PRINCIPAL)
    ...
    def test_basic_get_set_del_name_attribute_no_auth(self):
        ...
        self.assertEqual(canon_name.attributes['urn:greet:greeting'].values,
                         set([b'some val']))
        self.assertTrue(canon_name.attributes['urn:greet:greeting'].complete)
        self.assertFalse(
        ...
        # self.assertFalse(canon_name.attributes), which would normally give
        # an error.
...
class SecurityContextTestCase(_GSSAPIKerberosTestCase):
    ...
    def test_init_throws_error_on_invalid_args(self):
        ...
        self.assertRaises(TypeError, create_sec_context)
    ...
    def test_defer_step_error_on_complete_property_access(self):
        ...
        self.assertRaises(gb.BadChannelBindingsError, check_complete)
