...
from gssapi.raw.cython_converters cimport c_get_name_type_oid
from gssapi.raw.cython_converters cimport c_create_name_type
...
def importName(name not None, name_type=None):
    """
    ...
    if name_type is None:
        ...
        nt = c_get_name_type_oid(name_type)
    ...
    if maj_stat == GSS_S_COMPLETE:
        ...
        if name_type:
            if output_name_type == GSS_C_NO_OID:
                ...
                py_name_type = c_create_name_type(output_name_type)
        else:
            py_name_type = None
